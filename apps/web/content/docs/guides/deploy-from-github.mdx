...
- **Your own self-hosted GitHub App** — configure the App ID, client credentials, private key and webhook
  secret once, then use installation tokens without Openship Cloud or PATs. See
  [Self-hosted GitHub App](/docs/guides/self-hosted-github-app).
